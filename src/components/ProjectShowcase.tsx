...
const PROJECTS = [
  {
    ...
    desc: "A creative vehicle for high-impact visual storytelling by crafting narratives for ambitious African brands seeking to redefine their market presence.",
    video: "/novagen.mp4",
  ...
  },
  {
    ...
    desc: "Personal documentation of innovation and ambition through the African lens.",
